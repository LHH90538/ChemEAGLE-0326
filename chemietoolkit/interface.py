...
class ChemIEToolkit:
    ...
    def init_chemrxnextractor(self, ckpt_path=None):
        ...
        """
        if ckpt_path is None:
            ckpt_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "chemrxnextractor-training-modules")
